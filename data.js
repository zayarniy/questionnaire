...
let dataQuestions =
  [
...

    {
      ...
      questions:
        [
          ...
          `Панков Сергей. В какие 3 этапа работает протокол STP.
          Какие преимущества у STP.`,
          `Панков Сергей. По какому стандарту работает STP.
          Что такое протокол STP.
          Для чего нужен STP`,
          'Черников Антон. Сколько есть стандартов IEEE 802.11',
          'Черников Антон. Wi-Fi использует разделяемую среду из-за этого возможны ...',
          'Черников Антон. С помощью чего можно решить проблемы скрытой и засвеченной станции?',
          'Черников Антон. В беспроводной сети часто возникают ошибки из-за этого Wi-Fi использует ...',
          'Черников Антон. Какие есть дополнительные функции Wi-Fi?',
          'Черников Антон. Какие есть наборы сервисов Wi-Fi?'
        ]
...

    {
      ...
      questions:
        [
          ...
          'Представление числе в памяти компьютера. Как хранятся целые отрицательные числа',
    ...
    {
      groupName: 'Громов Игорь стандарты сетей',
      questions:
        [
          'Вопрос 1: Зачем нужны стандарты сетей?',
          'Вопрос 2: Какие бывают типы стандартов? ',
          'Вопрос 3: Для чего нужен стандарт IEEE?',
          'Вопрос 4: Какой номер у документа RFC для IP? ',
          'Вопрос 5: Всегда ли были стандарты сетей?',
          'Вопрос 6: За что отвечает документ RFC 793?'
        ]
